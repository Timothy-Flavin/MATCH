...
class SimpleEnv(AECEnv):
    ...
    def __init__(
        ...
        #)
        self.game_font = pygame.freetype.SysFont(None, 24)
        ...
        self.world = world
        self.continuous_actions = True#continuous_actions
    ...
    def _set_action(self, action, agent, action_space, time=None):
        ...
        if agent.movable:
            ...
            agent.action.u[0] += action[0][1] - action[0][3]
            agent.action.u[1] += action[0][0] - action[0][2]
    ...
    def step(self, action):
        ...
        #print(f"starting step with action: {action}")
        if (
